...
from src.submission.model import GPT, GPTConfig
from src.submission.dataset import NameDataset, CharCorruptionDataset
from src.submission.trainer import Trainer, TrainerConfig
from src.submission.utils import evaluate_places, sample
from src.submission.helper import initialize_vanilla_model, initialize_synthesizer_model, finetune, pretrain, train
from src.submission.attention import SynthesizerAttention, CausalSelfAttention
...
def main():
    ...
    block_size = 128
    # text= open('./data/wiki.txt', encoding='utf-8').read()
    ...
    if args['--function'] == "finetune":
        ...
        writing_params_path = './submission/vanilla.model.params'
        finetune_corpus_path = './data/birth_places_train.tsv'
        _, trainer_obj = finetune(reading_params_path, finetune_corpus_path, pretrain_dataset,
                                  block_size, attention_model)
        train(attention_model, writing_params_path, trainer_obj)
...
"vanilla_finetune_without_pretrain"

function= 'finetune'
variant = 'vanilla'
pretrain_corpus_path = '/Users/dimplebansal/Downloads/XCS224N-A5-master/src/data/wiki.txt'
reading_params_path = None
writing_params_path = '/Users/dimplebansal/Downloads/XCS224N-A5-master/src/submission/vanilla.model.params'
finetune_corpus_path = '/Users/dimplebansal/Downloads/XCS224N-A5-master/src/data/birth_places_train.tsv'
...
# Create model
device = setup_device()
attention_model = initialize_vanilla_model(mconf)
attention_model = attention_model.to(device)
...
reading_params_path = './submission/vanilla.model.params'
eval_corpus_path = './data/birth_dev.tsv'
outputs_path = './submission/vanilla.nopretrain.dev.predictions'
